...
def test_slider_paints_label_at_col0():
    f = _frame()
    render_slider(f, row=0, col=0, w=38, h=3, label="R", value=128, max_val=255,
...
def test_slider_paints_value_right_aligned():
    ...
    render_slider(f, row=0, col=0, w=38, h=3, label="R", value=255, max_val=255,
                  get_color=lambda v: RGB(v, 0, 0))
    LABEL_W, VALUE_W = 2, 4
...
def test_slider_track_cells_have_bg_color():
    f = _frame()
    render_slider(f, row=0, col=0, w=38, h=3, label="G", value=0, max_val=255,
...
def test_slider_marker_at_correct_position():
    ...
    render_slider(f, row=0, col=0, w=38, h=3, label="B", value=0, max_val=255,
...
def test_slider_shadow_row1_has_shadow_cell():
    ...
    render_slider(f, row=0, col=0, w=w, h=3, label="R", value=0, max_val=255,
                  get_color=lambda v: RGB(v, 0, 0))
...
def test_slider_col_offset_respected():
    f = _frame(w=50)
    render_slider(f, row=1, col=5, w=38, h=3, label="R", value=0, max_val=255,
                  get_color=lambda v: RGB(v, 0, 0))
...
def test_slider_fallback_no_get_color():
    ...
    render_slider(f, row=0, col=0, w=38, h=1, label="R", value=128, max_val=255,
                  get_color=None)
...
def test_slider_out_of_bounds_rows_dont_crash():
    ...
    f = Frame(40, 2)
    render_slider(f, row=0, col=0, w=38, h=3, label="R", value=0, max_val=255,
                  get_color=lambda v: RGB(v, 0, 0))
